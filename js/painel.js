...
function urlMenuOption(opcao){
	switch (opcao) {
		...
		case 'op33':
			...
			var link = 'inscricao_turma_interno.php?idevento=15&idregiao-abrangencia='+document.getElementById('idregiao-abrangencia').value;
			window.open(link);
			
			//return 'resource/res_pc_eventos_inscricao_turma_interna.php';
			break;
